    ...
    <div class="background">
        <div class="main-container">
            <div class="side-bar">
                ...
                <div class="details">
                    <img src="profile_icon.png" alt="Profile Icon" width="50px" height="50px">
                    <h4 style="margin-left: 15px; margin-right: 15px;">Syed Haris Ahmed<br><span style="color: lime; ">Border Resident</span></h4>
                    <img src="drop_down_icon.png" alt="DrownDropIcon" width="40px" height="40px">
                </div>
                ...
                <div class="log-out-div">
                    <img src="logout_icon.png" alt="Logout_Icon" width="50px" height="50px">
